      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
            Select the perfect plan for your family's needs. Start free and
            upgrade anytime as your family grows.
          </p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  ...
                  <th className="text-center py-4 px-6 font-semibold text-gray-900 dark:text-gray-100">
                    Free
                  </th>
                  <th className="text-center py-4 px-6 font-semibold text-gray-900 dark:text-gray-100">
                    Standard
        ...
        <div className="mt-20 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            We're here to help! Contact our support team for any pricing
            questions.
          </p>
