...
const mockMessages: Message[] = [
  {
    id: "1",
    content:
      "Remember that every challenge you face is making you stronger. Our family believes in you, and we're always here to support you through anything. You've got this! ✨",
    author: "Mom",
  ...
  },
  {
    id: "2",
    content:
      "Thinking about our amazing family vacation last summer. The way we all laughed together during that rainy day when we played board games for hours. Those are the moments that matter most. ❤️",
    author: "Dad",
  ...
  },
  {
    id: "3",
    content:
      "I'm so grateful for this beautiful family. Each one of you brings so much joy and love into my life. Thank you for being the best grandchildren a grandma could ask for!",
    author: "Grandma",
...
const Messages = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message: Message = {
      ...
      likes: 0,
      comments: 0,
      category: (selectedCategory as Message["category"]) || undefined,
    };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Share words of encouragement, memories, gratitude, and celebrations
          ...
          {messages.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Start sharing love and encouragement with your family
              </p>
              <Button
