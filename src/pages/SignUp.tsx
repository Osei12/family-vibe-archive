      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-2xl font-bold text-gray-800">Family Archive</span>
          </div>
          <p className="text-gray-600">Start preserving your family memories</p>
        </div>
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          ...
          <CardFooter>
            <div className="text-center text-sm text-gray-600 w-full">
              ...
              <Link to="/login" className="text-rose-600 hover:text-rose-500 font-medium hover:underline">
                Sign in
              </Link>
            </div>
          </CardFooter>
