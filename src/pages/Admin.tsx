      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
          <div className="flex items-center">
            ...
            <div>
              <div className="text-2xl font-bold text-gray-800 dark:text-gray-100">{mockFamilyMembers.length}</div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
          <div className="flex items-center">
            ...
            <div>
              ...
              <div className="text-gray-600 dark:text-gray-400 text-sm">Storage Used</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex-1">
            ...
            <main className="p-8">
              <Routes>
                ...
                <Route path="/roles" element={<div className="text-center py-12"><h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">User Roles Management</h2><p className="text-gray-600 dark:text-gray-300 mt-2">Coming soon...</p></div>} />
                <Route path="/analytics" element={<div className="text-center py-12"><h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">Analytics Dashboard</h2><p className="text-gray-600 dark:text-gray-300 mt-2">Coming soon...</p></div>} />
                <Route path="/backup" element={<div className="text-center py-12"><h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">Backup & Restore</h2><p className="text-gray-600 dark:text-gray-300 mt-2">Coming soon...</p></div>} />
                <Route path="/settings" element={<div className="text-center py-12"><h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">Settings</h2><p className="text-gray-600 dark:text-gray-300 mt-2">Coming soon...</p></div>} />
                <Route path="/security" element={<div className="text-center py-12"><h2 className="text-2xl font-semibent text-gray-800 dark:text-gray-100">Security Settings</h2><p className="text-gray-600 dark:text-gray-300 mt-2">Coming soon...</p></div>} />
                <Route path="/notifications" element={<div className="text-center py-12"><h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">Notification Settings</h2><p className="text-gray-600 dark:text-gray-300 mt-2">Coming soon...</p></div>} />
                <Route path="/privacy" element={<div className="text-center py-12"><h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">Privacy Settings</h2><p className="text-gray-600 dark:text-gray-300 mt-2">Coming soon...</p></div>} />
                <Route path="/billing" element={<div className="text-center py-12"><h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">Billing History</h2><p className="text-gray-600 dark:text-gray-300 mt-2">Coming soon...</p></div>} />
              </Routes>
            </main>
          </div>
        </div>
