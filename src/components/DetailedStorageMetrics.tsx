      ...
      <div className="space-y-4">
        ...
        <div>
          <div className="flex justify-between text-sm text-gray-600 dark:text-gray-300 mb-2">
            ...
            <span className="font-medium">{formatStorage(usedStorage)} of {formatStorage(totalStorage)}</span>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between text-sm mb-1">
            ...
            <span className="font-medium text-gray-800 dark:text-gray-100">{formatStorage(photosStorage)}</span>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between text-sm mb-1">
            ...
            <span className="font-medium text-gray-800 dark:text-gray-100">{formatStorage(documentsStorage)}</span>
          </div>
          <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
            <div 
